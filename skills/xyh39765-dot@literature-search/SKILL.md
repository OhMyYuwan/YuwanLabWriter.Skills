...
# 文献查找 (Literature Search)

> **原始出处：** 本技能内容改编自 [kthorn/research-superpower](https://github.com/kthorn/research-superpower)，原作者保留所有权利。此处仅做格式整理与分发适配。
...
**Announce at start:** "I'm using the Literature Search skill to find [specific data] about [topic]."
...
Papers scored using the rubric in `evaluating-paper-relevance/SKILL.md`:
...
See `evaluating-paper-relevance/SKILL.md` for guidance on when to create:
...
**Read `searching-literature/SKILL.md` and follow its instructions:**
...
**Read `evaluating-paper-relevance/SKILL.md` and follow its instructions:**
...
**Read `traversing-citations/SKILL.md` and follow its instructions:**
...
**Software:** Literature Search skill v1.0.0
...
💡 Optional: Clean up intermediate files?
   → Read `cleaning-up-research-sessions/SKILL.md` to safely remove temporary files
```
...
- [ ] Search PubMed (read `searching-literature/SKILL.md`)
- [ ] For each paper: evaluate (read `evaluating-paper-relevance/SKILL.md`)
- [ ] For relevant papers (≥7): traverse citations (read `traversing-citations/SKILL.md`)
...
**Sub-skills used:**
1. `searching-literature/SKILL.md` - Initial PubMed search
2. `evaluating-paper-relevance/SKILL.md` - Score and extract from papers
3. `traversing-citations/SKILL.md` - Follow citation networks

**Additionally referenced within the sub-skills:**
4. `checking-chembl/SKILL.md` - Check ChEMBL for curated bioactivity data
5. `finding-open-access-papers/SKILL.md` - Unpaywall for paywalled papers
6. `building-screening-rubrics/SKILL.md` - Build/validate scoring rubrics (large searches)
7. `subagent-driven-review/SKILL.md` - Parallel screening (50+ papers)
8. `cleaning-up-research-sessions/SKILL.md` - Remove intermediate files after completion
...
| Search | `searching-literature/SKILL.md` | List of papers with metadata |
| Evaluate | `evaluating-paper-relevance/SKILL.md` | Scored papers, extracted findings |
| Traverse | `traversing-citations/SKILL.md` | Additional papers from citations |
...
- **Optional**: Read `cleaning-up-research-sessions/SKILL.md` to remove intermediate files
