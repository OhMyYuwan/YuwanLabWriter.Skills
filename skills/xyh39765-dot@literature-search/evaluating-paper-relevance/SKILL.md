...
Read `checking-chembl/SKILL.md` to check if paper is in ChEMBL database:
```bash
...
Read `finding-open-access-papers/SKILL.md` to find free OA version:
```bash
...
- **Read `checking-chembl/SKILL.md`** to find curated SAR data
...
- **If paywalled: MANDATORY to read `finding-open-access-papers/SKILL.md` (Unpaywall)**
...
4. **Read `traversing-citations/SKILL.md`** to find related papers
...
- If score ≥ 7: Read `traversing-citations/SKILL.md`
